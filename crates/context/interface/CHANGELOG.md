...
## [1.0.0-alpha.6](https://github.com/nemnem7/revm/compare/revm-context-interface-v1.0.0-alpha.5...revm-context-interface-v1.0.0-alpha.6) - 2025-03-19

### Added

- Remove PrecompileError from PrecompileProvider ([#2233](https://github.com/nemnem7/revm/pull/2233))
- allow reuse of API for calculating initial tx gas for tx ([#2215](https://github.com/nemnem7/revm/pull/2215))
